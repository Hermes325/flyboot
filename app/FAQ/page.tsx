  ...
  return (<main className='pt-[90px] min-h-screen  px-[13%]'>
    ...
    <DropDown title="Почему везем с POIZON?">
      <div>
        ...
        <ol>
          <li className='font-montserrat text-white'>1. Привлекательная стоимость товаров</li>
          <li className='font-montserrat text-white'>2. Многократная проверка всего товара на оригинальность.</li>
        </ol>
