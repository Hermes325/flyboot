...
const About = () => {
  return (
    <main className={styles.main + ' relative overflow-hidden'}>
      <h1 className={styles.Montserrat700_2 + " font-montserrat min-[2560px]:!text-[6.5rem] max-[1860px]:!text-[4.5rem] max-[1700px]:!text-[4rem] max-[1500px]:!text-[3.7rem] max-[1330px]:!text-[3.3rem] max-[1140px]:!text-[3rem] max-[600px]:!text-[2.5rem]"}>
        О нас
      </h1>
      ...
      <Image
        src={right_hand}
        alt="правая рука"
        className={styles.right_hand + " max-[1700px]:!top-[7%] max-[1400px]:!top-[8%] max-[1300px]:!top-[9%]"}
      />
      <div className='mt-[2vw] mb-[15vw]'>
        ...
        <div>
          ...
          <p className={styles.font_au + " mt-[2.5vw] font-montserrat  max-[1700px]:!mt-[25px] max-[1650px]:!text-[22px] max-[1550px]:!mt-[20px] max-[1400px]:!text-[20px] max-[1300px]:!text-[16px] max-[1250px]:!leading-[22px]"}>
      ...
      <Image
        src={left_hand}
        alt="левая рука"
        className={styles.left_hand + " max-[1700px]:!top-[7%] max-[1400px]:!top-[8%] max-[1300px]:!top-[9%]"}
      />
