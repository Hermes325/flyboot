...
const Privacy = () => {
  return (
    <main className='min-h-screen flex flex-col items-center justify-start pt-[158px] max-[1300px]:!pt-[120px]  px-[9vw] relative overflow-hidden'>

      <h1 className={styles.Montserrat700_2 + ` font-montserrat 
      max-[1300px]:!mt-[8vw] 
      ...
      <div className='mt-[2vw] mb-[15vw]'>
        ...
        <h2 className='mt-[60px] text-4xl'>
          1. ОПРЕДЕЛЕНИЕ ТЕРМИНОВ
        </h2>
        <div>
          <p className={styles.font_au + " mt-[1.5vw] text-justify font-montserrat  max-[1700px]:!mt-[25px] max-[1650px]:!text-[22px] max-[1550px]:!mt-[20px] max-[1400px]:!text-[20px] max-[1300px]:!text-[16px] max-[1250px]:!leading-[22px]"}>
        ...
        <div>
          ...
          <p className={styles.font_au + " mt-[1.5vw] text-justify font-montserrat  max-[1700px]:!mt-[25px] max-[1650px]:!text-[22px] max-[1550px]:!mt-[20px] max-[1400px]:!text-[20px] max-[1300px]:!text-[16px] max-[1250px]:!leading-[22px]"}>
            ...
            <ol>
              <li className={styles.font_au + " mt-[1.5vw] text-justify font-montserrat  max-[1700px]:!mt-[25px] max-[1650px]:!text-[22px] max-[1550px]:!mt-[20px] max-[1400px]:!text-[20px] max-[1300px]:!text-[16px] max-[1250px]:!leading-[22px]"}>
