    ...
    <section className="w-full px-[16.7vw]">
      <div className="mb-[10vw]">
        ...
        <p
          className={
            styles.jost_offer +
            " font-jost max-[1860px]:text-[22px] max-[1700px]:text-[20px] max-[1500px]:text-[18px] max-[1330px]:text-[16.5px] max-[1140px]:text-[15px]"
          }
        >
        ...
        <form action="#catalog" className="mt-[1vw]">
          <button
            className={
              styles.button_main +
              " font-montserrat p-[18px_30px_20px_30px] max-[1860px]:text-[35px] max-[1700px]:text-[30px] max-[1500px]:text-[27px] max-[1330px]:text-[25px] max-[1140px]:text-[22px]"
            }
          >
            Смотреть каталог
          </button>
      ...
      <div>
        ...
        <div>
          ...
          <div
            className={
              styles.krug2 +
              " max-[1860px]:w-[9vw] max-[1550px]:w-[7vw] max-[1750px]:mt-[3%] max-[1700px]:mt-[1%] max-[1550px]:mt-[4%] max-[1200px]:mt-[9%] max-[1025px]:mt-[13%]"
            }
          />
          <div
            className={
          ...
          <div
            className={
              styles.krug4 +
              " max-[1750px]:w-[6vw] max-[1750px]:mt-[5%] max-[1700px]:w-[7vw] max-[1550px]:w-[9vw] max-[1700px]:mt-[-1%] max-[1550px]:mt-[0%] max-[1450px]:w-[7vw] max-[1300px]:mt-[13%]"
            }
          />
        </div>
      </div>
