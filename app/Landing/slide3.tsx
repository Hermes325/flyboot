...
function Slide3() {
  return (
    <section id="catalog" className="translate-y-5 px-[16.7vw]">
      <p className={styles.jost_p_center + " mt-[2vw] text-center flex justify-center"}>
      ...
      <div className={styles.container}>
        ...
        <a href="">
          <form action="//НАДО СЮДА ПРОПИСАТЬ ССЫЛКУ" className={styles.ramochka_child}>
            <button className={styles.btn + " flex gap-[25px]"}>
              <h3>Кроссовки</h3>
              <Image
                src={vector}
                alt="купить"
